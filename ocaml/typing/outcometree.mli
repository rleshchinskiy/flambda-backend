...
type out_module_with =
  | OmtyWith_module of string * out_ident
  | OmtyWith_type of string * out_ident

type out_module_type =
  | Omty_abstract
  | Omty_functor of (string option * out_module_type) option * out_module_type
  | Omty_ident of out_ident
  | Omty_signature of (out_ident * out_module_with list) option * out_sig_item list
